		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Request an IT Equipment",
									"targetURL": "#ui5applicationmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5applicationmodule-display": {
								"semanticObject": "ui5applicationmodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5applicationmodule",
									"url": sap.ui.require.toUrl("ui5applicationmodule")
								}
							}
						}
					}
